...
class Parallogram : virtual public Quadrilateral{
    double base, height;
public:
    Parallogram(){}
    Parallogram(double a, double b)
    {
        base = a;
        height = b;
    }
    ...
    double ask()
    {
        cout << "The height of the Parallogram is : " << height << "\n";
        cout << "The base of the Parallogram is   : " << base << "\n";
        cout << "What is the Area of the Parallogram? \nAns : ";
        double ans;
        cin >> ans;
        return ans;
    }
